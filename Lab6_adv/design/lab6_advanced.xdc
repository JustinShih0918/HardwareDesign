...
# # LEDs
set_property PACKAGE_PIN U16 [get_ports {cur_state[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cur_state[0]}]
set_property PACKAGE_PIN E19 [get_ports {cur_state[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cur_state[1]}]
# set_property PACKAGE_PIN U19 [get_ports {LED[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {LED[2]}]
set_property PACKAGE_PIN V19 [get_ports {recovery}]
set_property IOSTANDARD LVCMOS33 [get_ports {recovery}]
...
set_property PACKAGE_PIN N3 [get_ports {LMR[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LMR[0]}]
set_property PACKAGE_PIN P1 [get_ports {LMR[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LMR[1]}]
set_property PACKAGE_PIN L1 [get_ports {LMR[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LMR[2]}]
