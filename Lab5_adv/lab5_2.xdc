...
set_property PACKAGE_PIN V19 [get_ports {cur_state[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cur_state[1]}]
set_property PACKAGE_PIN W18 [get_ports {flip}]
...
set_property PACKAGE_PIN N3 [get_ports {key[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {key[2]}]
set_property PACKAGE_PIN P1 [get_ports {key[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {key[3]}]
set_property PACKAGE_PIN L1 [get_ports {key[4]}]
