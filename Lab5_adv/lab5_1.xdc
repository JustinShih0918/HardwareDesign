...
## LEDs
# set_property PACKAGE_PIN U16 [get_ports {zoom_val[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {zoom_val[0]}]
# set_property PACKAGE_PIN E19 [get_ports {zoom_val[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {zoom_val[1]}]
