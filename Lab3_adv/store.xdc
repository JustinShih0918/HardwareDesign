...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {pos[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos[0]}]
set_property PACKAGE_PIN E19 [get_ports {pos[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos[1]}]
set_property PACKAGE_PIN U19 [get_ports {pos[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos[2]}]
set_property PACKAGE_PIN V19 [get_ports {pos[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos[3]}]
set_property PACKAGE_PIN W18 [get_ports {mode[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mode[0]}]
set_property PACKAGE_PIN U15 [get_ports {mode[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mode[1]}]
set_property PACKAGE_PIN U14 [get_ports {mode[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mode[2]}]
set_property PACKAGE_PIN V14 [get_ports {mode[3]}]
