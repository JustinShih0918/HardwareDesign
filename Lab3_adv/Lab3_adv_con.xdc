...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {RB}]
set_property IOSTANDARD LVCMOS33 [get_ports {RB}]
set_property PACKAGE_PIN E19 [get_ports {LB}]
set_property IOSTANDARD LVCMOS33 [get_ports {LB}]
set_property PACKAGE_PIN U19 [get_ports {UB}]
set_property IOSTANDARD LVCMOS33 [get_ports {UB}]
set_property PACKAGE_PIN V19 [get_ports {DB}]
set_property PACKAGE_PIN W18 [get_ports {init}]
set_property IOSTANDARD LVCMOS33 [get_ports {init}]
set_property PACKAGE_PIN U15 [get_ports {move}]
set_property IOSTANDARD LVCMOS33 [get_ports {move}]
set_property PACKAGE_PIN U14 [get_ports {fall}]
