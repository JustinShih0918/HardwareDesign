...
# set_property PACKAGE_PIN P3 [get_ports {cur_key_num[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {cur_key_num[0]}]
# set_property PACKAGE_PIN N3 [get_ports {cur_key_num[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {cur_key_num[1]}]
# set_property PACKAGE_PIN P1 [get_ports {cur_key_num[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {cur_key_num[2]}]
# set_property PACKAGE_PIN L1 [get_ports {cur_key_num[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {cur_key_num[3]}]
...
set_property PACKAGE_PIN T18 [get_ports volUP]
   set_property IOSTANDARD LVCMOS33 [get_ports volUP]
set_property PACKAGE_PIN W19 [get_ports octaveDOWN]
   set_property IOSTANDARD LVCMOS33 [get_ports octaveDOWN]
set_property PACKAGE_PIN T17 [get_ports octaveUP]
   set_property IOSTANDARD LVCMOS33 [get_ports octaveUP]
set_property PACKAGE_PIN U17 [get_ports volDOWN]
   set_property IOSTANDARD LVCMOS33 [get_ports volDOWN]
