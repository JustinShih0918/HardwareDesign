...
# set_property PACKAGE_PIN P3 [get_ports {vol[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {vol[0]}]
# set_property PACKAGE_PIN N3 [get_ports {vol[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {vol[1]}]
# set_property PACKAGE_PIN P1 [get_ports {vol[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {vol[2]}]
# set_property PACKAGE_PIN L1 [get_ports {vol[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {vol[3]}]
